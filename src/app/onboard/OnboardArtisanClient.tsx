        ...
        <div className="relative z-10 space-y-6">
          <Link href="/" className="inline-block mb-12">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-brand-blue font-black text-xl shadow-lg">
                {siteName.charAt(0)}
              </div>
              <span className="text-white font-black uppercase tracking-widest text-lg">{siteName.split(' ')[0]} <span className="text-brand-gold">Network</span></span>
            </div>
          </Link>
