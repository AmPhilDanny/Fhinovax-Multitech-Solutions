            ...
            {messages.length === 0 && (
              <div className="h-full flex flex-col items-center justify-center text-center max-w-md mx-auto space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3 w-full">
                  <button onClick={() => { setInput("Generator won't start"); sendMessage({ role: 'user', text: "Generator won't start" }); }} className="p-3 bg-white/5 border border-white/10 rounded-xl text-[10px] font-bold hover:bg-white/10 transition-colors uppercase">
                    Generator won't start
                  </button>
                  <button onClick={() => { setInput("Car engine knocking sound"); sendMessage({ role: 'user', text: "Car engine knocking sound" }); }} className="p-3 bg-white/5 border border-white/10 rounded-xl text-[10px] font-bold hover:bg-white/10 transition-colors uppercase">
