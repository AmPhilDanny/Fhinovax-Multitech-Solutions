            ...
            {messages.length === 0 && (
              <div className="h-full flex flex-col items-center justify-center text-center max-w-md mx-auto space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3 w-full">
                  ...
                  <button onClick={() => { setInput("Car engine knocking sound"); sendMessage({ text: "Car engine knocking sound" }); }} className="p-3 bg-white/5 border border-white/10 rounded-xl text-[10px] font-bold hover:bg-white/10 transition-colors uppercase">
              ...
              >
                <div className={`max-w-[85%] md:max-w-[70%] rounded-2xl p-4 shadow-2xl ${
                  ...
                  <div className="text-[10px] font-black uppercase tracking-widest mb-2 opacity-50">
                    {m.role === 'user' ? 'Operator' : systemName}
                  </div>
