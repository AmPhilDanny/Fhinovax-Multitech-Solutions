      ...
      <aside className="w-full md:w-64 bg-white border-r border-gray-200 flex-shrink-0">
        ...
        <nav className="p-4 space-y-2">
          ...
          <div className="pt-4 border-t border-gray-100 flex flex-col gap-2">
            <Link href="/" className="px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-gray-500 hover:text-brand-blue flex items-center justify-between group transition-all">
              ...
              <span className="text-[8px] bg-green-50 text-green-600 px-1.5 py-0.5 rounded opacity-0 group-hover:opacity-100 transition-opacity uppercase">Online</span>
            </Link>
          </div>
